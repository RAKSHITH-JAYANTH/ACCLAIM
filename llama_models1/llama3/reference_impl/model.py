...
class Attention(nn.Module):
    def __init__(self, args: ModelArgs, layer_id: int):
        ...
        self.cache_k_path = rf"C:\Users\raksh\Documents\Accel-Long\cache_k1_{layer_id}.dat"
        self.cache_v_path = rf"C:\Users\raksh\Documents\Accel-Long\cache_v1_{layer_id}.dat"
        self.mask_bs_path = rf"C:\Users\raksh\Documents\Accel-Long\mask_bs_{layer_id}.dat"
        self.score_bs_path = rf"C:\Users\raksh\Documents\Accel-Long\score_bs_{layer_id}.dat"
        self.mask_est_path = rf"C:\Users\raksh\Documents\Accel-Long\mask_est_{layer_id}.dat"
    ...
    def prefill_forward(
        ...
        streams = [torch.xpu.Stream() for _ in range(32 // 2)]

        for sub_key, value in self.distribution_dict.items():
            with torch.xpu.stream(streams[int(sub_key) // 2]):
...
class Transformer(nn.Module):
    def __init__(self, params: ModelArgs):
        ...
        self.embed_path = rf"C:\Users\raksh\Documents\Accel-Long\ixput_embed.dat"
        self.dim = params.dim
        # Initialize memory-mapped files for cache_k and cache_v
        self.print_1 = 0
    ...
    def forward(self, tokens: torch.Tensor, start_pos: int, is_prefill: bool, begin: int, end: int, prompt_len: int, chunk_size: int):
        ...
        if is_prefill:
            ...
            for layer in self.layers:
                ...
                layer.attention.mask_generation(layer.attention_norm(torch.tensor(h)), freqs_cis, chunk_size, seqlen)
